		...
		quint16 senderPort)
{
	...
	quint32 rcvTerm = appendEntry.value("term").toUInt();
	QString rcvId = appendEntry.value("id").toString();
	quint32 rcvPrevLogIndex = appendEntry.value("prevLogIndex").toUInt();
	quint32 rcvPrevLogTerm = appendEntry.value("prevLogTerm").toUInt();

	quint32 rcvCommitIndex = appendEntry.value("leaderCommit").toUInt();
...
//		appendEntryToSend["AppendEntries"]["entries"] =
		appendEntryToSend["AppendEntries"]["entries"].toMap();
